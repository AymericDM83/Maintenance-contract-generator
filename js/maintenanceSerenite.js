...
const maintenancePriceTab = [
  181.36, 207.27, 236.74, 279.1, 254.38, 267.33, 314.44, 135.44, 199.03, 266.16,
  314.43, 349.78,
];
...
const deplacementSuppPriceTab = [0, 50.38, 98.92, 148.38];
...
const optionSuppPriceTab = [0, 62.96, 57.33];
